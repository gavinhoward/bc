...
#ifdef DC_CONFIG
const BcLexToken dc_lex_tokens[] = {
	...
	BC_LEX_INVALID, BC_LEX_REL_EQ_ZERO, BC_LEX_KEY_OBASE, BC_LEX_PRINT_STREAM,
	...
	BC_LEX_STORE_IBASE, BC_LEX_INVALID, BC_LEX_STORE_SCALE, BC_LEX_LOAD_VAR,
	BC_LEX_INVALID, BC_LEX_KEY_PRINT, BC_LEX_STORE_OBASE, BC_LEX_PRINT_NEWLINE,
	BC_LEX_KEY_QUIT, BC_LEX_SWAP, BC_LEX_STORE_VAR, BC_LEX_INVALID,
